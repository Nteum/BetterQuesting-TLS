...
public class GuiQuest extends GuiScreenCanvas implements IPEventListener, INeedsRefresh
{
    ...
    private PanelButton btnTaskLeft;    //提交任务按钮左侧切换任务的 <
    private PanelButton btnTaskRight;   //提交任务按钮右侧切换任务的 >
    private PanelButton btnRewardLeft;  //获得奖励按钮左侧切换任务的 <
    private PanelButton btnRewardRight; //获得奖励按钮右侧切换任务的 >

    private PanelButton btnDetect;  //提交任务按钮
    private PanelButton btnClaim;   //获得奖励按钮

    private PanelTextBox titleReward;   //此页面的奖励
    private PanelTextBox titleTask;     //此页面的任务
